...
import { useGetWalletDetailsQuery, useFreezeWalletMutation, useUnfreezeWalletMutation, useCloseWalletMutation } from '@/lib/api/walletsApi';
import { useToast } from '@/components/ui/toast/ToastProvider';
import { CardShimmer } from '@/components/ui/Shimmer';
import { ArrowLeft, Bank, User, Hash, LockKey, LockKeyOpen, Trash, CircleNotch } from '@phosphor-icons/react';
